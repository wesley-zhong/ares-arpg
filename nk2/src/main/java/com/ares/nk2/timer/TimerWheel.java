...
//    private static final Logger LOGGER = LoggerFactory.getLogger(TimerWheel.class);
    ...
    boolean addTimer(TimerHandle timer) {
        if (timer.next != null) {
            ...
            throw new IllegalStateException(NKStringFormater.format("timer-{} already in timerManager-{}.", timer, timer.next.getTimerManager()));
        }
        ...
        if (timer.getExpireTick() >= currentTick) {
            ...
            throw new IllegalStateException(NKStringFormater.format("timer-{} already expired, currentTick {}, expiredTick {}", timer, currentTick, timer.getExpireTick()));
        }
        ++count;
        ...
        while (timerHandle != null) {
            ...
            if (timerHandle.getExpireTick() >= currentTick) {
                ...
                throw new IllegalStateException(
                        NKStringFormater.format("timer-{} already expired, currentTick {}, expiredTick {}",
