    ...
    public void createCompts(BaseEntity entityInst,
        ...
        for (Class<? extends BaseComponent> comptClazz : comptClazzList) {
            try {
                ...
                throw new FyLogicException(ProtoCommon.ErrCode.COMPONENT_CONSTRUCT_ERROR_VALUE, NKStringFormater.format("entity-{} create component-{} failed. ", entityInst, comptClazz.getSimpleName()), e);
            } catch (Throwable t) {
