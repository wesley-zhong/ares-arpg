...
public class GameModule {
    public static abstract class ModuleContainer<T extends Module> {
        ...
        private Map<ProtoCommon.GameModuleId, T> modules = new LinkedHashMap<>();
        ...
        public T getModule(ProtoCommon.GameModuleId moduleId) {
    ...
    public static abstract class Module  {
         ...
         * @return 模块Id枚举
         */
        public abstract ProtoCommon.GameModuleId getModuleId();
    }
}