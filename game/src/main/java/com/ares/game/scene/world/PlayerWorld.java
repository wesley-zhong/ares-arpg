...
//        notifyPreEnterMpPlayer(uid, slot_info.nickname, proto::PlayerPreEnterMpNotify::START);
    ...
    public void playerEnter(Player player) {
        ...
        if (isWorldFull())
        {
            throw new UnknownLogicException("uid: " + uid + " playerEnter fails, world full, owner: " + owner_player.getUid());
        }
        WorldPlayerSlotInfo slotInfo = slotInfoMap.get(uid);
        if (slotInfo == null) {
            throw new UnknownLogicException("world owner: " + owner_player.getUid() + " cannot found slot for uid: " + uid);
        }
...
//        }
        ...
        log.debug("[WORLD] uid: " + uid + " enter world, owner: " + owner_player.getUid());
...
//        owner_player.getMpModule().removeEnterAllowPlayerUid(player.getUid());
        ...
        player.getSceneModule().setCurWorldOwnerUid(owner_player.getUid());
...
//        if (scene_team_ != null)
//        {
//            scene_team_.onPlayerEnter(player);
//        }
//        else
//        {
//            LOG_ERROR + "SceneTeam is null, owner_player" + *owner_player;
//        }
...
//    });
        ...
        notifyWorldAndOwnerData(owner_player, player);
...
//        }
        ...
        log.info( "uid: " + uid + " enter owner: " + owner_player.getUid() + " world");
    }
...
//        if (scene_team_ != null)
//        {
//            scene_team_.onPlayerLeave(uid);
//        }
//        else
//        {
//            LOG_ERROR + "SceneTeam is null, uid:" + uid + " owner_uid:" + owner_uid;
//        }
...
//            }
    ...
    public void notifyWorldData(Player player) {
        ...
        Player ownPlayer1 = getOwnPlayer();
        if (ownPlayer1 != null)
        {
            notifyWorldAndOwnerData(ownPlayer1, player);
        }
    }
}
