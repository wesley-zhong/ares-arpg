...
public class SceneMgr {
    ...
    public static Scene createScene(int sceneId, Player player) {
        ...
        switch (sceneType) {
            ...
            case SCENE_ROOM:
                ...
                break;
            default:
                throw new FyLogicException(ProtoErrorCode.ErrCode.UNKNOWN_VALUE, "Invalid scene type: " + sceneType);
        }
    ...
    private static ProtoCommon.SceneType getSceneTypeBySceneId(int sceneId) {
        switch (sceneId) {
            ...
            default:
                throw new FyLogicException(ProtoErrorCode.ErrCode.UNKNOWN_VALUE, "Invalid sceneId: " + sceneId);
        }
    }
}
