...
import com.ares.game.scene.entity.PlayerEyePoint;
...
//#endif
    ...
    private PlayerChangeEyePropGuardState changeEyePropGuardState = PlayerChangeEyePropGuardState.PLAYER_CHANGE_EYE_PROP_GUARD_STATE_DONE;
...
//            }
        ...
        player.sendMessage(ProtoCommon.MsgId.PLAYER_EYE_POINT_STATE_NTF, notify.build());
    }
