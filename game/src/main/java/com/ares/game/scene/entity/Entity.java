...
//            is_move_sent_reliable_ = true;
    ...
    void broadcastMotionInfo(ProtoScene.MotionInfo motionInfo, MotionContext motionContext)
    {
        ...
        scene.notifyViewingPlayersExclude(this, ProtoCommon.MsgId.SCENE_ENTITIES_MOVE_NTF, notify.build(), motionContext.excludeUid, true);
    }
    ...
    public void notifyLastMotionInfo(Player player)
    {
        ...
        player.sendMessage(ProtoCommon.MsgId.SCENE_ENTITIES_MOVE_NTF, notify.build());
    }
