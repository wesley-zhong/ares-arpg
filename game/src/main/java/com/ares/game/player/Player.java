...
//            }
        ...
        sendMessage(ProtoMsgId.MsgId.PLAYER_ENTER_SCENE_NTF, notify.build());
...
//        }
        ...
        sendMessage(ProtoMsgId.MsgId.ENTER_SCENE_PEER_NTF, notify.build());
...
//        sendProto(notify);
    ...
    public void sendMessage(ProtoMsgId.MsgId msgId, Message message) {
