...
public class PlayerSceneModule extends PlayerModule {
    ...
    public PlayerSceneModule(Player player) {
        super(ProtoInner.GameModuleId.GMI_PlayerScene, player);
    ...
    public void joinPlayerScene(long targetUid) {
        ...
        {
            throw new FyLogicException(ProtoErrorCode.ErrCode.RET_PLAYER_NOT_ONLINE_VALUE, "findOnlinePlayer failed, targetUid:" + targetUid + " uid:" + getPlayer().getUid());
        }
