...
public class PeerConn extends PeerConnBase implements InitializingBean {
    ...
    public void sendRouter(long uid, int msgId, Message body) {
        routerTo(ServerType.ROUTER, uid, msgId, body);
    }

    public void sendGateWayMsg(long uid, int msgId) {
        send(ServerType.GATEWAY, uid, msgId, null);
    }
    ...
    public void removePlayerContext(long uid) {
        playerIdContext.remove(uid);
    }
